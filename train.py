...
tf.flags.DEFINE_string("positive_data_file", "./data/ham_all.utf8", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/spam_all.utf8", "Data source for the negative data.")
...
sentences, max_document_length = data_helpers.padding_sentences(x_text, '<PADDING>',padding_sentence_length=50)
